...
import static org.spotify.oauth2.api.TokenManager.renewToken;
...
public class PlaylistApi {
    ...
    public static Response post(Playlist requestPlaylist) {
        return RestResource.post("/users/3127ntzuaopscs44bj3jokvgmss4/playlists", renewToken(), requestPlaylist);
    }
